export default [
  {
    ...
    price: 45.89,
    description:
      "Juicy and delicious apples to capture the essence of nature. Ideal for enjoying as a snack or incorporating into pies, salads, and applesauce. .",
    ratings: 4.5,
    images: [
      {
    ...
    category: "Fruits",
    seller: "farmer of the vijayawada",
    stock: 50,
    numOfReviews: 32,
    reviews: [],
  },
  ...
  },
  {
    ...
    price: 26.99,
    description:
      "Sweet and succulent strawberries that bring a burst of flavor to your life. Mount them on your TV wall with the CHARMOUNT TV MOUNT UNIVERSAL DESIGN and enjoy the universal appeal of these berries. Suitable for TVs from 26 to 55 inches, these mounts provide a tilt for the perfect viewing angle.",
    ratings: 3.5,
    images: [
      {
  ...
  },
  {
    ...
    price: 27.99,
    description:
    "Cultivatude with organic farming enhanced with vitamins",
    ratings: 4.1,
    images: [
      {
  ...
  },
  {
    ...
    price: 90,
    description:
      "Enjoy the goodness of homegrown McIntosh Kiwis from Kauffman's Fruit Farm & Market. Known for their pretty red/green color and white flesh, these kiwis are perfect for snacking, pies, salads, and applesauce. Protected with soft, high-density foam for safe shipping to your door.",
    ratings: 5,
    images: [
      {
  ...
  },
  {
    ...
    price: 60,
    description:
      "With the juicy and sour experience of the fruit",
    ratings: 4.9,
    images: [
      {
  ...
  },
  {
    ...
    price: 86,
    description:
      "With the juicy and experience of the fruit",
    ratings: 4.9,
    images: [
      {
  ...
  },
  {
    ...
    price: 64,
    description:
      "Fresh milk with enriched with calcium",
    ratings: 4.9,
    images: [
      {
